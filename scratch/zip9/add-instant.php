      ...
      <div class="form-group" style="margin-top:24px">
        ...
        <div style="display:flex; gap:16px; margin-bottom:12px;">
          <label style="display:inline-flex; align-items:center; gap:8px; cursor:pointer;">
            <input type="radio" name="image_type" value="link" checked onchange="toggleImageTypeInstant(this.value)"> استخدام رابط
          </label>
          <label style="display:inline-flex; align-items:center; gap:8px; cursor:pointer;">
            <input type="radio" name="image_type" value="upload" onchange="toggleImageTypeInstant(this.value)"> رفع من الجهاز
          </label>
        </div>
