...
-- SEED DATA (Demo)
-- ============================================================
INSERT IGNORE INTO `users` (`id`, `full_name`, `mobile`, `email`, `role`, `nafath_verified`, `is_active`) VALUES
(1, 'أحمد المدير',       '0500000001', 'admin@fleetx.sa',    'admin',     1, 1),
(2, 'الوطنية للتأجير',   '0500000002', 'watania@fleetx.sa',  'seller',    1, 1),
(3, 'بدجت السعودية',     '0500000003', 'budget@fleetx.sa',   'seller',    1, 1),
(4, 'محمد المشتري',      '0501111111', 'buyer1@example.com', 'buyer',     1, 1),
(5, 'خالد الزهراني',     '0502222222', 'buyer2@example.com', 'buyer',     1, 1),
(6, 'المفتش الأول',      '0503333333', 'insp@fleetx.sa',     'inspector', 1, 1),
(7, 'يلو لتأجير السيارات', '0500000007', 'yellow@fleetx.sa',  'seller',    1, 1),
(8, 'ذيب لتأجير السيارات', '0500000008', 'theeb@fleetx.sa',   'seller',    1, 1),
(9, 'هرتز السعودية',     '0500000009', 'hertz@fleetx.sa',   'seller',    1, 1);
